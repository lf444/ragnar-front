...
interface MyRewardsProps {
  ...
  const MyRewards: FunctionComponent<MyRewardsProps> = ({
      nftMetadata
    }) => {
    ...
    return (
        <>
          ...
          >
            <Typography sx={{marginBottom: "18px", marginTop: "100px"}}>Total Rewards: {NFTrewards.toLocaleString("en")}</Typography>
            <Typography sx={{marginBottom: "18px"}}>Total Pending bRGN: {bRGNPending.toLocaleString("en")}</Typography>
            <Typography sx={{marginBottom: "18px"}}>Total bRGN Lock: {bRGNLock.toLocaleString("en")}</Typography>
            <Typography sx={{marginBottom: "18px"}}>Total RGN Lock: {RGNlock.toLocaleString("en")}</Typography>
            <Typography sx={{marginBottom: "18px"}}>Power of Gouvernance: {powerGouvernance.toLocaleString("en")}%  <Tooltip title="Governance power is relative to the number of bRGN locks in your NFTs and not to the bRGNs in pending.">
                  <InfoRoundedIcon
                    sx={{
